 ...
 * 
 * 
 * @FindBy(xpath = "//td[@class='headertext'][1]") WebElement Name;
 * 
 ...
 * 
 * @FindBy(xpath = "//a[contains(text(),'Companies')]") WebElement
 * Companieslink;
 * 
 ...
 * }
 * 
 * public boolean verifyCorrectusername() { return Name.isDisplayed(); }
 * 
 * public void clickonNewContactLink() { Actions ac = new Actions(driver);
 * ac.moveToElement(Contactslink).build().perform(); newContactLink.click(); }
 * 
 * }
 */