 ...
 * 
 * private static String title; private LoginPage loginPage = new
 ...
 * page_title_should_be(String expectedTitleName) {
 ...
 * user_enters_password(String password) { loginPage.enterPassword(password); }
 * 
